...
routerLogRiegos.get('/:id', function (req, res) {
    ...
    inner join Electrovalvulas e on e.electrovalvulaId = d.electrovalvulaId
    inner join Log_Riegos l on l.electrovalvulaId = e.electrovalvulaId
    where d.dispositivoId= ${req.params.id} order by l.fecha desc
